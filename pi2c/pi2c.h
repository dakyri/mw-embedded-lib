...
public:
	 ...
	 */
	void writeByte(uint8_t reg, uint8_t value) { wiringPiI2CWriteReg8(dfd, reg, value); }
	void writeByte(uint8_t value) {	wiringPiI2CWrite(dfd, value); }

	/*!
	 *  Read byte from register
	 */
	uint8_t readByte(uint8_t reg) { return wiringPiI2CRead8(dfd, reg); }
	uint8_t readByte() { return wiringPiI2CRead(dfd); }
	 ...
	 */
	int readBuf(uint8_t reg, size_t n, uint8_t *buf) { return wiringPiI2CReadBlockData (fd, reg, *buf, n); }
	int writeBuf(uint8_t reg, size_t n, uint8_t *buf) { return wiringPiI2CWriteBlockData (fd, reg, *buf, n); }
